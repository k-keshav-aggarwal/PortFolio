  ...
  return (
    <section id="hero" className="hero-gradient min-h-screen flex items-center pt-16 relative">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-10">
        <div className="absolute top-1/4 left-1/4 text-8xl text-primary">
          <Code />
        </div>
        <div className="absolute top-3/4 left-1/5 text-7xl text-accent">
          {`{}`}
        </div>
        <div className="absolute top-1/3 right-1/4 text-6xl text-primary/70">
          <Terminal />
        </div>
        <div className="absolute bottom-1/4 right-1/3 text-8xl text-accent/70">
          <Coffee />
        </div>
        <div className="absolute bottom-1/3 left-2/3 text-5xl text-primary/50">
          {"</>"} 
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mt-6 animate-fade-in flex items-center gap-4" style={{ animationDelay: '0.1s' }}>
            <span className="text-gradient text-7xl">Keshav Aggarwal</span><br />
            <span className="bg-primary/10 text-primary text-sm py-1 px-2 rounded hidden md:inline-block">dev</span>
          </h1>
          <h2 className="text-3xl md:text-5xl font-bold mt-4 text-muted-foreground animate-fade-in" style={{ animationDelay: '0.2s' }}>
